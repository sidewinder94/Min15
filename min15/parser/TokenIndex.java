...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTIntern(@SuppressWarnings("unused") TIntern node)
    {
        this.index = 4;
    }
    ...
    @Override
    public void caseTIsa(@SuppressWarnings("unused") TIsa node)
    {
        this.index = 13;
    }
    ...
    @Override
    public void caseTClassName(@SuppressWarnings("unused") TClassName node)
    {
        this.index = 40;
    }

    @Override
    public void caseTFieldName(@SuppressWarnings("unused") TFieldName node)
    {
        this.index = 41;
    }

    @Override
    public void caseTInvalidFieldName(@SuppressWarnings("unused") TInvalidFieldName node)
    {
        this.index = 42;
    }
